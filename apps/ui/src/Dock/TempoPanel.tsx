...
import { Eyebrow, mono } from "./DockPanelKit";
import {
  SPEED_PRESETS,
  multiplierToSlider,
  sliderToMultiplier,
...
/**
 * Tempo details panel: a big monospace multiplier with
 ...
 *
 * It carries no heading of its own: the panel's single header row ("Tempo",
 * with the way out) is drawn by `AnchoredPanel`. This used to stack three —
 * the panel eyebrow, then an eyebrow and a title inside the body.
 *
    ...
    <div className="flex flex-col gap-[15px] p-[15px]">
      <div className="flex items-end justify-between gap-3">
        ...
        <div className="text-right">
          ...
          <div
            className={cn(mono, "mt-[3px] text-[26px] font-semibold leading-none text-foreground")}
          >
            {timeStr}
          </div>
        </div>
