...
/**
 * Asks before a mode switch throws away in-flight map work. Rendered in the work
 * dock, on top of the rail that was describing the work — so the question
 * appears exactly where the thing being discarded was reported.
 */
