      ...
      >
        ...
        {open && (
          <div className="relative">
            <CommandList className="absolute top-1 z-50 max-h-[400px] w-full origin-top animate-scale-in overflow-y-auto rounded-md border border-border surface-glass glass-frost p-1 shadow-floating">
